...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("BEM VINDO AO SISTEMA DE PAGAMENTOS GUIBANK");

        System.out.print("Digite o saldo inicial da Conta Corrente: ");
        double saldoCC = leitor.nextDouble();
        contacorrente cc = new contacorrente("Luis guilherme", saldoCC, 2000.0);

        System.out.print("Digite o saldo inicial da Conta Poupança: ");
        double saldoCP = leitor.nextDouble();
        contapoupanca cp = new contapoupanca("Fernanda", saldoCP, 0.5);

        System.out.print("Digite o saldo inicial da Conta Empresarial: ");
        double saldoCE = leitor.nextDouble();
        contaempresarial ce = new contaempresarial("Uniesp", saldoCE, "123444568865", 15000.0, "Bali Store LTDA");
